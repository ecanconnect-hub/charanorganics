-- ========================================================
-- ⚠️ SECURE CHECKOUT RPC - V5 (CLEANUP & FIX)
-- ========================================================
-- This script dynamically finds and drops ALL versions of the
-- 'place_secure_order' function to resolve "not unique" errors.
-- Then it re-creates the function with the correct logic.
-- ========================================================

-- 1. Dynamic Cleanup of ALL overloaded signatures
DO $$ 
DECLARE 
    r RECORD;
    stmt TEXT;
...
-- 3. Re-create Function (Logic: Keep Cart Items)
