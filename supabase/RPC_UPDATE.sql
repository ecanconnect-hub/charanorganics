-- Add email parameter to place_secure_order RPC function
-- This is necessary because we need to link orders to emails even for guest users
...
BEGIN
    ...
    INSERT INTO public.orders (
        ...
        shipping_address,
        payment_status,
        email -- Make sure 'email' column exists in 'orders' table
    ) VALUES (
        p_user_id,
        v_readable_id,
    ...
    LOOP
        ...
        INSERT INTO public.order_items (
            ...
            unit_price,
            total_price,
            product_title_en, -- Snapshot of name
            product_title_te,
            variant_label
        ) VALUES (
            v_order_id,
