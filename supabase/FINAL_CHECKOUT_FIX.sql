-- ============================================
-- FINAL SAFE CHECKOUT MIGRATION
-- ============================================
-- This migration drops ALL versions of place_secure_order and creates the correct one
-- ============================================
...
-- STEP 3: Drop ALL existing versions of place_secure_order function
-- ============================================

DROP FUNCTION IF EXISTS public.place_secure_order CASCADE;

-- STEP 4: Create the CORRECT place_secure_order function
-- ============================================
